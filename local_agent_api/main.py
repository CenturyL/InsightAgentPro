...
import uvicorn
from local_agent_api.api.routes import router as chat_router
from local_agent_api.core.config import settings
from local_agent_api.services import agent_service
...
if __name__ == "__main__":
    ...
    uvicorn.run("local_agent_api.main:app", host="0.0.0.0", port=8000, reload=True)
